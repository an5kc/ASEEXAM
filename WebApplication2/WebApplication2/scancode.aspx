<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scancode.aspx.cs" Inherits="WebApplication2.scancode" %>
...
<div style="width:330px;float:left;">
    ...
    <form id="form1" runat="server">
        ...
        <div style="width:200px;float:left;">
            ...
            <p>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="scancode.aspx">snapshot</asp:HyperLink>
